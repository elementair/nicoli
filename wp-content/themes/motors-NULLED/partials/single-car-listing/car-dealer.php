				...
				<div class="clearfix">
					...
					<?php if(!empty($ratings['average'])): ?>
						<div class="dealer-rating">
							...
							<div class="stm-rate-sum">(<?php esc_html_e('Opiniones', 'motors'); ?> <?php echo esc_attr($ratings['count']); ?>)</div>
						</div>
					<?php endif; ?>
				</div>
				...
				<div class="dealer-contacts">
					<?php if(!empty($user_fields['phone'])): ?>
						<div class="dealer-contact-unit phone">
                            ...
                            <?php else : ?>
                                ...
                                <span class="stm-show-number" data-id="<?php echo $user_fields['user_id']; ?>"><?php echo esc_html__("Mostrar numero", "motors"); ?></span>
                            <?php endif; ?>
						</div>
					<?php endif; ?>
					...
					<?php if(!empty($user_fields['email']) and !empty($user_fields['show_mail']) and $user_fields['show_mail'] == 'show'): ?>
						<div class="dealer-contact-unit mail">
							...
							<div class="stm-label"><?php esc_html_e('Correo electrónico del vendedor', 'motors'); ?></div>
