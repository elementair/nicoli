...
<div class="title">
    ...
    <div class="subtitle heading-font"><?php esc_html_e('Por favor seleccione su vehículo ', 'motors'); ?></div>
</div>
<div class="image image-placeholder">
    <a href="<?php echo esc_url(stm_woo_shop_page_url()); ?>">
        ...
        <span class="button">
            <?php esc_html_e('Encontrar un vehiculo', 'motors'); ?>
...
<div class="stm_rent_table">
    <div class="heading heading-font"><h4><?php esc_html_e('Tarifa', 'motors'); ?></h4></div>
    <table>
