...
?>
    ...
    <div class="stm_rent_table">
        ...
        <table>
            <thead class="heading-font">
                <tr>
                    <td><?php esc_html_e('CANTIDAD', 'motors'); ?></td>
                    <td><?php esc_html_e('Tarifa', 'motors'); ?></td>
            ...
            <tbody>
                ...
                <tr>
                    <td><?php echo sprintf(esc_html__('%s Dias', 'motors'), $car_rent['days']); ?></td>
                    <td><?php echo wc_price($car_rent['Precio']); ?></td>
            ...
            <tfoot class="heading-font">
                <tr>
                    <td colspan="2"><?php esc_html_e('Tarifa de alquiler', 'motors'); ?></td>
                    <td><?php echo wc_price($car_rent['total']); ?></td>
                </tr>
            </tfoot>
        </table>
    ...
    <?php if(!empty($cart_items['options'])): ?>
        <div class="stm_rent_table">
            <div class="heading heading-font"><h4><?php esc_html_e('Complementos', 'motors'); ?></h4></div>
            <table>
                <thead class="heading-font">
                    <tr>
                        <td><?php esc_html_e('CANTIDAD', 'motors'); ?></td>
                ...
                <tbody>
                    ...
                    <?php foreach($cart_items['options'] as $car_option): ?>
                        <tr>
                            <td><?php echo sprintf(esc_html__('%s x %1s %s %s Dia(s)', 'motors'), ($car_option['quantity']/$car_rent['days']), $car_option['name'], "for", $car_rent['days']); ?></td>
                ...
                <tfoot class="heading-font">
                    <tr>
                        <td colspan="2"><?php esc_html_e('Tasa de cargos de complementos', 'motors'); ?></td>
    ...
    <div class="stm-rent-total heading-font">
        <table>
            <tr>
                <td><?php esc_html_e('Total Estimado', 'motors'); ?></td>
