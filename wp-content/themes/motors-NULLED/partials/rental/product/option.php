    ...
    <div class="stm_rental_option_content">
        <div class="content">
            ...
            <?php if(!empty($excerpt)): ?>
                <div class="stm-more">
                    <a href="#">
                        <span><?php esc_html_e('Más Información', 'motors'); ?></span>
        ...
        <div class="meta">
            ...
            <div class="price">
                <?php if(!empty($sale_price)): ?>
                    <div class="sale_price"><?php sprintf( esc_html__('%s/Día', 'motors'), wc_price($reg_price)); ?></div>
                <?php else: ?>
                    <div class="empty_sale_price"></div>
                <?php endif; ?>
                <div class="current_price heading-font">
                    <?php sprintf(esc_html__('%s/Día', 'motors'), wc_price($price)); ?>
                </div>
            </div>
            ...
            <?php if(!$added): ?>
                <div class="stm-add-to-cart heading-font stm-manage-stock-<?php echo esc_attr($manage_stock); ?>">
                    <a href="<?php echo esc_url($url); ?>">
                        <?php esc_html_e('Añadir', 'motors'); ?>
                    </a>
                </div>
            <?php else: ?>
                <div class="stm-add-to-cart added heading-font stm-manage-stock-<?php echo esc_attr($manage_stock); ?>">
                    <a href="<?php echo esc_url($url); ?>">
                        <span class="add_text"><?php esc_html_e('Añadidos', 'motors'); ?></span>
                        <span class="remove_text"><?php esc_html_e('Eliminar', 'motors'); ?></span>
                    </a>
                </div>
            <?php endif; ?>
