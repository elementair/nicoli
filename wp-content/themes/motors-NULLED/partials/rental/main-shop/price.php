                ...
                <?php foreach($prices as $price): ?>
                    <div class="stm_rent_price">
                        ...
                        <?php if(!empty($max_price) and $price['total'] < $max_price ) : ?>
                            <div class="stm_discount"><?php echo sprintf( __('Ahorraste %s', 'motors'), wc_price($max_price - $price['total']) ); ?></div>
                        <?php endif; ?>
                    </div>
                <?php endforeach; ?>
            </div>
        ...
        if(!empty($price) and $url): ?>
            <div class="stm_rent_prices">
                <div class="stm_rent_price">
                    ...
                    <div class="pay">
                        <a class="heading-font" href="<?php echo esc_url($url); ?>"><?php esc_html_e('Pagar ahora', 'motors'); ?></a>
                    </div>
                </div>
            </div>
        <?php endif; ?>
