...
<div class="stm_single_class_car <?php echo esc_attr($current_car); ?> <?php echo esc_attr($disableCar)?>" id="product-<?php echo $id; ?>">
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="top">
                        ...
                        <?php if(!empty($excerpt)): ?>
                            <div class="stm-more">
                                <a href="#">
                                    <span><?php esc_html_e('Mas Información', 'motors'); ?></span>
	...
	<?php if(!empty($disableCar)): ?>
		<div class="stm-enable-car-date">
			...
			?>
			<h3><?php echo esc_html__('Esta clase ya está reservada en:', 'motors') . "<span class='yellow'>" . implode('<span>,</span> ', $formatedDates);?></span>.</h3>
		</div>
	<?php endif; ?>
</div>