<?php
    ...
    $type_label = sprintf(esc_html__('%s Tipo', 'motors'), $type_label);
...
<div class="inner <?php echo esc_attr($class); ?>">
    <a href="<?php echo esc_url(stm_woo_shop_page_url()); ?>" class="top heading-font">
        ...
        <label><?php esc_html_e('Seleccione Vehículo / Complementos', 'motors'); ?></label>
    </a>
    <div class="content">
        <div class="first">
        ...
        <div class="second">
            <?php if(!empty($items['car_class'])): ?>
                <a class="h5" href="<?php echo esc_url(get_permalink($items['car_class']['id'])); ?>"><?php esc_html_e('Complementos', 'motors'); ?></a>
            <?php else: ?>
                <h5><?php esc_html_e('Complementos', 'motors'); ?></h5>
            <?php endif; ?>
