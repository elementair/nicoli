            ...
            <li>
                <?php if (in_array(get_the_ID(), $cars_in_compare)): ?>
                    <a
                        ...
                        <span class="stm-unhover"><?php esc_html_e('en la lista de comparación', 'motors'); ?></span>
                        <div class="stm-show-on-hover">
                            <i class="stm-icon-remove"></i>
                            <?php esc_html_e('Quitar de la lista', 'motors'); ?>
                        </div>
                    </a>
                <?php else: ?>
                    <a
                        ...
                        <?php esc_html_e('Añadir a comparar', 'motors'); ?>
                    </a>
                <?php endif; ?>
            </li>
        <?php endif; ?>
            ...
            <?php if (!empty($car_brochure)): ?>
                <li>
                    <a
                        ...
                        title="<?php esc_html_e('Descargar folleto', 'motors'); ?>"
                        download>
                        <i class="stm-icon-brochure"></i>
                        <?php esc_html_e('Folleto del coche', 'motors'); ?>
                    </a>
                </li>
            <?php endif; ?>
        <?php endif; ?>
        ...
        <?php if (!empty($show_share) and $show_share): ?>
            <li class="stm-shareble">
                ...
                <a
                    ...
                    title="<?php esc_html_e('Compartir este', 'motors'); ?>"
                    download>
                    <i class="stm-icon-share"></i>
                    <?php esc_html_e('Compartir este', 'motors'); ?>
                </a>
        ...
        <?php if (!empty($show_print_btn) and $show_print_btn): ?>
            <li>
                <a href="javascript:window.print()" class="car-action-unit stm-car-print heading-font">
                    ...
                    <?php echo esc_html__('Imprimir página', 'motors'); ?>
                </a>
            </li>
        <?php endif; ?>
