						...
						<div class="col-md-<?php echo esc_attr($filter_columns_number); ?> col-sm-6">
							...
							<div class="form-group">
								<select name="<?php echo esc_attr($taxonomy_term_key) ?>" class="form-control">
									<option value="">
										<?php echo esc_html__('Seleccionar', 'motors').' '.esc_html__(stm_get_name_by_slug($taxonomy_term_key), 'motors'); ?>
									</option>
					...
					<div class="row">
						<div class="col-md-12 col-sm-12">
							...
							<div class="stm_mc-found">
								<span class="number-label"><?php esc_html_e('encontró:', 'motors'); ?></span>
								<span class="number-found"><?php echo intval($posts); ?></span>
								<?php esc_html_e('Vehículos', 'motors'); ?>
							</div>
							<button type="submit" class="button icon-button">
								<?php esc_html_e('Buscar', 'motors'); ?>
							</button>
						</div>
					</div>
				</div>
