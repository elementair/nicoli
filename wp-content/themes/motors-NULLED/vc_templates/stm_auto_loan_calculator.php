...
$default_interest_rate = get_theme_mod("default_interest_rate", "");
$default_month_period = get_theme_mod("default_month_period", "");
$default_down_payment = get_theme_mod("default_down_payment", "");
	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="form-group">
				<div class="labeled <?php if(!empty($label_font_size)){ echo 'heading-font'; } ?>"><?php esc_html_e("Precio del vehículo",'motors');?> <span class="orange">(<?php echo $currency_symbol; ?>)</span></div>
			...
			<div class="row">
				<div class="col-md-6 col-sm-6">
					...
					<div class="form-group md-mg-rt">
						<div class="labeled <?php if(!empty($label_font_size)){ echo 'heading-font'; } ?>"><?php esc_html_e("Tasa de interés",'motors');?> <span class="orange">(%)</span></div>
				...
				<div class="col-md-6 col-sm-6">
					...
					<div class="form-group md-mg-lt">
						<div class="labeled <?php if(!empty($label_font_size)){ echo 'heading-font'; } ?>"><?php esc_html_e("Período",'motors');?> <span class="orange">(<?php esc_html_e('mes','motors'); ?>)</span></div>
			...
			<!--Down Payment-->
			<div class="form-group">
				<div class="labeled <?php if(!empty($label_font_size)){ echo 'heading-font'; } ?>"><?php esc_html_e("Pago inicial",'motors');?> <span class="orange">(<?php echo $currency_symbol; ?>)</span></div>
				<input type="text" class="numbersOnly down_payment" value="<?php echo esc_html($default_down_payment); ?>"/>
			</div>


			<a href="" class="button button-sm calculate_loan_payment dp-in"><?php esc_html_e("Calculate", "motors"); ?></a>
