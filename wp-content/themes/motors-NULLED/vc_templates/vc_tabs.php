 ...
 */
$title = $interval = $el_class = $vc_tabs_style_2 = '';
$atts = vc_map_get_attributes( $this->getShortcode(), $atts );
extract( $atts );

if(empty($vc_tabs_style_2) and $vc_tabs_style_2 != 'yes' ) {
	$vc_tabs_style_2 = 'stm_tabs_style_1';
} else {
	$vc_tabs_style_2 = 'stm_tabs_style_2';
}

if(!empty($vc_tabs_style_service) and $vc_tabs_style_service == 'yes') {
...
if ( 'vc_tour' === $this->shortcode ) {
	$next_prev_nav = '<div class="wpb_tour_next_prev_nav vc_clearfix"> <span class="wpb_prev_slide"><a href="#prev" title="' . __( 'Pestaña anterior', 'motors' ) . '">' . __( 'Pestaña anterior', 'motors' ) . '</a></span> <span class="wpb_next_slide"><a href="#next" title="' . __( 'Pestaña siguiente', 'motors' ) . '">' . __( 'Pestaña siguiente', 'motors' ) . '</a></span></div>';
} else {
	$next_prev_nav = '';
}
