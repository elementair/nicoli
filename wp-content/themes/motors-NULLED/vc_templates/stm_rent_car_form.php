...
<div class="stm_rent_car_form_wrapper <?php echo esc_attr($style_type . ' ' . $align . ' ' . $css_class); ?>">
    <div class="stm_rent_car_form">
        <form action="<?php echo esc_url($form_url); ?>" method="get">
            <h4><?php esc_html_e('Recoger', 'motors'); ?></h4>
            <div class="stm_rent_form_fields">
                <h4 class="stm_form_title"><?php esc_html_e('Lugar para recoger el coche*', 'motors'); ?></h4>
                <div class="stm_pickup_location">
                    <i class="stm-service-icon-pin"></i>
                    <select name="pickup_location" data-class="stm_rent_location">
                        <option value=""><?php esc_html_e('Elegir oficina', 'motors'); ?></option>
                ...
                <label>
                    ...
                    <?php esc_html_e('Volver al mismo lugar', 'motors'); ?>
                </label>
                <div class="stm_date_time_input">
                    <h4 class="stm_form_title"><?php esc_html_e('Fecha/hora de recogida*', 'motors'); ?></h4>
            ...
            <div class="stm_rent_form_fields stm_rent_form_fields-drop">
                ...
                <div class="stm_date_time_input">
                    <h4 class="stm_form_title"><?php esc_html_e('Fecha/hora de entrega*', 'motors'); ?></h4>
                    <div class="stm_date_input">
                        <input type="text" class="stm-date-timepicker-end" name="return_date"
                               value="<?php echo sanitize_text_field($fields['return_date']) ?>"
                               placeholder="<?php esc_html_e('Fecha de regreso', 'motors') ?>" required readonly/>
                        <i class="stm-icon-date"></i>
                    </div>
                </div>
            </div>
            ...
            <?php if ($style_type == 'style_1'): ?>
                <button type="submit"><?php esc_html_e('Encontrar un vehiculo', 'motors'); ?><i
                        class="fa fa-arrow-right"></i></button>
            <?php else: ?>
                <button type="submit"><?php esc_html_e('Continuar reserva', 'motors'); ?></button>
            <?php endif; ?>
